...
self-updating message (a "board") that lists the upcoming sessions and is
...
Each session on the trainings board has a **Manage** button that opens a
for-your-eyes-only message with **Join as Co-Host** / **Join as Helper**
buttons - or a **Leave** button when you have already joined. Joining and
leaving register directly in Supabase: the Discord id is resolved to a
